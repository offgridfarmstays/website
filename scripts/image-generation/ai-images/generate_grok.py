...
PROMPTS = {
    ...
    'hot_tub_heat_reuse': {
        'prompt': """Mountain hot tub at sunset with steam rising, wooden deck overlooking valley. Split composition showing scenic beauty and technical cutaway. Left side: hot tub, mountains, golden hour light. Right side: transparent view of underground immersion cooling tank with bitcoin miners, heat exchanger pipes with orange glow lines connecting to hot tub. Fog Hashing equipment style. Blend lifestyle photography with engineering diagram. Warm wood, blue water, sunset gold, copper pipes, atmospheric steam.""",
        'size': '1792x1024',
        'quality': 'hd'
    },

    'bitcoin_mining_heat_luxury': {
        'prompt': """Off-grid cabin at twilight with steaming hot tub, mountains background. Person relaxing in hot tub on wood deck. Semi-transparent overlay showing underground Fog Hashing immersion tanks with bitcoin miners, heat exchanger coils, orange thermal flow lines connecting mining equipment to hot tub and cabin heating. Solar panels on roof. Stars appearing in sky. Balance luxury lifestyle with technical innovation. Warm cabin lights, hot tub steam, orange heat flow, industrial silver equipment. Architectural Digest meets WIRED aesthetic.""",
        'size': '1792x1024',
        'quality': 'hd'
    },

    'heat_flow_lifestyle': {
        'prompt': """Wide hero banner: Left shows wooden hot tub on mountain deck, couple enjoying sunset, steam rising, dramatic vista. Right shows cutaway of Fog Hashing immersion tanks below deck, ASIC miners in clear fluid, heat exchanger coils, copper pipes rising with orange heat flow indicators. Center blends both: deck structure and thermal integration. Steam creates natural transition. Golden hour warmth left, LED lighting right. Apple product aesthetic meets National Geographic. Technology meets relaxation.""",
        'size': '1792x1024',
        'quality': 'hd'
    },

    'winter_hot_tub_bitcoin_heated': {
        'prompt': """Snowy cabin at night, warm lights in windows. Person in steaming hot tub on snow-covered deck under starry sky with Northern Lights. Technical overlay showing underground Fog Hashing immersion system with bitcoin miners generating heat, insulated pipes carrying hot water to surface. Contrast between freezing winter and steaming comfort demonstrates heat reuse. Subtle heat flow arrows and temperature gradients. Cool blues for night and snow, warm oranges for cabin lights and heat flow, white steam, silver mining equipment. Outdoor lifestyle magazine meets technical innovation.""",
        'size': '1792x1024',
        'quality': 'hd'
    },
}
